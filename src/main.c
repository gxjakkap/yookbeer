...
/*
 * removeElementFromArray() - remove element from Student array
 *
 *  - Stdent *arr: array of Student containing element to remove
 *  - int *len: pointer to len integer from main function
 *  - int idx: index of element to remove
 *
 *  remove an element from index and shift latter element by one
 */
